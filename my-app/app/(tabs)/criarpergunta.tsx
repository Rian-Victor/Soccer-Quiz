...
export default function CreateQuestions() {
  // SRP: este componente cuida apenas da criação de perguntas e respostas.
  ...
  // ISP: loadQuestions mantém a interface de leitura separada das operações de escrita do modal.
  ...
  // ISP: handleSaveNewQuestion gerencia exclusivamente o fluxo de salvamento para não misturar responsabilidades.
